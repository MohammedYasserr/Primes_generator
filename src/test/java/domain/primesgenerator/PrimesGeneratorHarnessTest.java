package domain.primesgenerator;
...
public class PrimesGeneratorHarnessTest {

    @InjectMocks
    private PrimesGeneratorHarness primesGeneratorHarness = new PrimesGeneratorHarness();
